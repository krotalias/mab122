...
class Polygon(object):
    ...
    def interiorPoint(self):
        ...
        l = box.len()
        def r(i): return box[0][i] + random() * l[i]
    ...
    def exteriorPoint(self):
        ...
        def off(): return 1 - 2 * random()

        l = box.len()
        def r(i): return box[0][i] + random() * l[i] + off()
...
def main():
    ...
    pol = Polygon([Point(0, 0, 0), Point(1, 0, 0),
    ...
    pol2 = Polygon([Point(1, 0, 0), Point(0, 1, 0), Point(
        1. / 3, 1. / 3, 1. / 3), Point(0, 0, 1)])
